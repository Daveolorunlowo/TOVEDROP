      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 pb-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm text-foreground/50 leading-relaxed max-w-[13rem]">
          ...
          {/* Col 2 — Platform */}
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-widest text-foreground/40 mb-5">Platform</h3>
            <ul className="flex flex-col gap-3">
              {platformLinks.map((link) => (
                <li key={link.label}>
                  <Link href={link.href} onClick={link.isBookRide ? handleBookRideClick : undefined} className="text-sm text-foreground/60 hover:text-foreground transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          {/* Col 3 — Company */}
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-widest text-foreground/40 mb-5">Company</h3>
            <ul className="flex flex-col gap-3">
          ...
          {/* Col 4 — Newsletter */}
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-widest text-foreground/40 mb-5">Stay Updated</h3>
            ...
            <form className="flex flex-col gap-2" onSubmit={(e) => e.preventDefault()}>
              ...
              <button
                type="submit"
                className="w-full px-4 py-2.5 rounded-lg text-foreground text-sm font-semibold transition-all hover:scale-[1.02]"
