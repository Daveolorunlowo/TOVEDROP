...
export function AdminSidebar({ children }: { children: React.ReactNode }) {
 ...
 <aside
 className={cn(
 'fixed inset-y-0 left-0 z-50 flex flex-col lg:static lg:z-auto transition-transform duration-200 bg-card h-screen shrink-0',
 ...
 {/* Topbar */}
 <header
 className="sticky top-0 z-30 flex items-center gap-3 px-5 h-12 shrink-0 bg-card border-b border-border"
