...
export function LiveMap() {
 ...
 <div className="absolute bottom-4 left-4 z-[400] bg-card border border-border px-3 py-2 rounded-lg text-[10px] font-medium flex flex-col gap-2 pointer-events-none">
