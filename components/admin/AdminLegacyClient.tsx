...
export function AdminLegacyClient({ initialTab }: { initialTab: string }) {
 ...
 className="bg-card border border-red-500/20 rounded-xl p-4 flex items-center justify-between"
 >
 ...
 className="bg-card border border-blue-500/20 rounded-xl p-4 flex items-center justify-between"
 >
 <div className="flex items-center gap-3">
