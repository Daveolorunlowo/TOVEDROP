...
export function UpdateFormModal({ update, onClose, onRefresh }: { update: any, onClose: () => void, onRefresh: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-background/60 backdrop-blur-sm p-4">
      <div className="bg-background border border-border rounded-xl w-full max-w-lg shadow-2xl flex flex-col animate-fade-in-up">
        ...
        <div className="p-4 space-y-4 overflow-y-auto max-h-[70vh]">
          ...
          <div>
            <label className="block text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1.5">Body</label>
            <textarea
              value={content}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1.5">Audience</label>
              <select
                value={audience}
        ...
        <div className="p-4 border-t border-border flex items-center justify-end gap-3 bg-card rounded-b-xl">
          ...
          <button
            ...
            disabled={!!loadingAction}
            className="bg-orange-brand hover:bg-orange-600 text-foreground px-4 py-2 rounded-md text-sm font-semibold transition-colors shadow-lg"
          >
