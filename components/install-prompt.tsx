...
export function InstallPrompt() {
 ...
 return (
 <div className="fixed bottom-0 left-0 right-0 p-4 z-50 animate-in slide-in-">
 <div className="bg-surface-card border border-border shadow-lg rounded-xl p-4 flex flex-col sm:flex-row items-center gap-4 max-w-lg mx-auto relative">
 <button 
