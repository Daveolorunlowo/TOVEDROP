...
export async function WalletTab({ 
 ...
 return (
 <div id="paginated-container" className="space-y-6 animate-in fade-in slide-in- duration-300 scroll-mt-24">
 {/* Wallet Balance Overview */}
 <div className="bg-surface-elevated border border-border rounded-xl p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative overflow-hidden">
 ...
 <button className="px-5 py-2.5 rounded-lg text-sm font-bold bg-orange-brand text-primary-foreground hover:brightness-110 transition-all whitespace-nowrap">
 Request Withdrawal
 </button>
 </div>
