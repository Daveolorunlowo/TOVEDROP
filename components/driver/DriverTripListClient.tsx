...
export function DriverTripListClient({
 ...
 subtab === 'upcoming' ? 'bg-orange-brand text-white ' : 'text-muted-foreground hover:text-foreground'
 }`}
 >
 Upcoming
 </Link>
 ...
 scroll={false}
 className={`flex-1 text-center py-2 text-sm font-semibold rounded-md transition-colors ${
 subtab === 'past' ? 'bg-orange-brand text-white ' : 'text-muted-foreground hover:text-foreground'
 }`}
 >
 Past
 </Link>
