...
export function ClientAutoRefresher() {
 ...
 return (
 <div className="flex items-center gap-1.5 text-[10px] font-medium text-muted-foreground bg-surface-elevated px-2 py-1 rounded-full border border-border-subtle">
