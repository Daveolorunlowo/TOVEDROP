...
export function TripPoller({ userId }: { userId: string }) {
 ...
 return (
 <div className="fixed bottom-4 right-4 z-50 bg-surface-elevated border-2 border-status-success text-primary px-5 py-4 rounded-xl shadow-xl flex items-center justify-between gap-6 animate-in slide-in- max-w-sm">
