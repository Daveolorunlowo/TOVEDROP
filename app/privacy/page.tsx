      ...
      <main className="flex-1 pt-24 pb-20">
        <div className="max-w-4xl mx-auto px-6 sm:px-10 lg:px-16">
          ...
          <section className="py-20 border-b border-white/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-foreground font-bold mb-1">What we collect</h3>
                  <p className="text-sm text-foreground/60">Name, email, phone, location during rides, and payment info.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-foreground font-bold mb-1">What we don't do</h3>
                  <p className="text-sm text-foreground/60">We don't sell your data, share with marketers, or track you after rides end.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-foreground font-bold mb-1">Who has access</h3>
                  <p className="text-sm text-foreground/60">Your driver (during the ride), TOVEDROP support, and our payment processor only.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-foreground font-bold mb-1">How you control it</h3>
                  <p className="text-sm text-foreground/60">Download your data or delete your account anytime. Opt out of optional features.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="py-20">
            <h2 className="text-2xl font-bold text-foreground mb-10">Full Privacy Policy</h2>
            
            <div className="space-y-12 text-foreground/70 text-[15px] leading-relaxed">
              
              <div>
                <h3 className="text-xl font-bold text-foreground mb-4">1. Data We Collect</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-foreground mb-4">2. How We Use Your Data</h3>
                <ul className="list-disc list-outside ml-5 space-y-2">
              ...
              <div>
                <h3 className="text-xl font-bold text-foreground mb-4">3. Who We Share Data With</h3>
                <ul className="list-disc list-outside ml-5 space-y-2">
              ...
              <div>
                <h3 className="text-xl font-bold text-foreground mb-4">4. How Long We Keep Your Data</h3>
                <ul className="list-disc list-outside ml-5 space-y-2">
              ...
              <div>
                <h3 className="text-xl font-bold text-foreground mb-4">5. Your Rights</h3>
                <ul className="list-disc list-outside ml-5 space-y-2">
              ...
              <div>
                <h3 className="text-xl font-bold text-foreground mb-4">7. Changes to This Policy</h3>
                <p>We may update this policy. You'll be notified via email if changes affect your privacy rights.</p>
              </div>

              <div>
                <h3 className="text-xl font-bold text-foreground mb-4">8. Contact Us</h3>
