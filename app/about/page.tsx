      ...
      <main className="flex-1 pt-24 pb-20">
        <div className="max-w-4xl mx-auto px-6 sm:px-10 lg:px-16">
          ...
          <section className="py-20 border-b border-white/10">
            <h2 className="text-2xl font-bold text-white mb-10 text-center">How It Operates</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
              ...
              <div className="bg-surface-card border border-white/10 rounded-2xl p-6 flex flex-col items-center text-center relative z-10">
                ...
                <h3 className="text-white font-bold mb-2">Book with Drops</h3>
              ...
              <div className="bg-surface-card border border-white/10 rounded-2xl p-6 flex flex-col items-center text-center relative z-10">
                ...
                <h3 className="text-white font-bold mb-2">Get Matched</h3>
                <p className="text-sm text-white/60">
              ...
              <div className="bg-surface-card border border-white/10 rounded-2xl p-6 flex flex-col items-center text-center relative z-10">
                ...
                <h3 className="text-white font-bold mb-2">Ride Securely</h3>
                <p className="text-sm text-white/60">
          ...
          <section className="py-20 border-b border-white/10">
            <h2 className="text-2xl font-bold text-white mb-10 text-center">The Benefits</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="bg-white/5 rounded-2xl p-6 border border-white/5 hover:border-white/10 transition-colors">
                ...
                <h3 className="text-white font-bold mb-2">Unmatched Safety</h3>
                <p className="text-sm text-white/60">
              ...
              <div className="bg-white/5 rounded-2xl p-6 border border-white/5 hover:border-white/10 transition-colors">
                ...
                <h3 className="text-white font-bold mb-2">100% Cashless</h3>
                <p className="text-sm text-white/60">
              ...
              <div className="bg-white/5 rounded-2xl p-6 border border-white/5 hover:border-white/10 transition-colors">
                ...
                <h3 className="text-white font-bold mb-2">Campus-Specific Routes</h3>
                <p className="text-sm text-white/60">
              ...
              <div className="bg-white/5 rounded-2xl p-6 border border-white/5 hover:border-white/10 transition-colors">
                ...
                <h3 className="text-white font-bold mb-2">Built for the Community</h3>
                <p className="text-sm text-white/60">
          ...
          <section className="py-20 text-center">
            <h2 className="text-3xl font-extrabold text-white mb-6">Experience the campus network</h2>
            <Link
