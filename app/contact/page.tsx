      ...
      <main className="flex-1 pt-24 pb-20">
        <div className="max-w-4xl mx-auto px-6 sm:px-10 lg:px-16">
          ...
          <section className="py-20 border-b border-white/10">
            <h2 className="text-2xl font-bold text-white mb-10 text-center">How to reach us</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-surface-card border border-white/10 rounded-2xl p-6">
                ...
                <p className="text-sm font-semibold text-white/90 mb-3">support@tovedrop.app</p>
                <p className="text-xs text-white/50 mb-4">General support, account issues, billing</p>
                <div className="text-[11px] uppercase tracking-widest text-white/30 font-bold">Response: 2hrs (weekday)</div>
              </div>
              ...
              <div className="bg-surface-card border border-white/10 rounded-2xl p-6">
                ...
                <h3 className="text-white font-bold mb-1">In-App Chat</h3>
                <p className="text-sm font-semibold text-white/90 mb-3">Settings → Help</p>
                <p className="text-xs text-white/50 mb-4">Fastest way to reach us for ride issues</p>
                <div className="text-[11px] uppercase tracking-widest text-white/30 font-bold">Response: 30 mins</div>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-6 md:col-span-2 lg:col-span-1">
                ...
                <h3 className="text-white font-bold mb-1">Safety Emergency</h3>
                <p className="text-sm font-semibold text-red-400 mb-3">safety@tovedrop.app</p>
                <p className="text-xs text-white/60 mb-4">Safety concerns only (rides, drivers, security)</p>
              ...
              <div className="bg-surface-card border border-white/10 rounded-2xl p-6 md:col-span-1 lg:col-span-2">
                ...
                <h3 className="text-white font-bold mb-1">Partnership / Press</h3>
                <p className="text-sm font-semibold text-white/90 mb-3">hello@tovedrop.app</p>
                <p className="text-xs text-white/50 mb-4">Media inquiries, campus partnerships, sponsorships</p>
                <div className="text-[11px] uppercase tracking-widest text-white/30 font-bold">Response: 24 hrs</div>
              </div>
          ...
          {/* Section 3: FAQ */}
          <section className="py-20 border-b border-white/10">
            <h2 className="text-2xl font-bold text-white mb-10 text-center">Quick answers</h2>
            ...
            <div className="max-w-2xl mx-auto space-y-3">
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  >
                    <span className="font-semibold text-sm text-white/90 pr-4">{faq.q}</span>
                    {openFaq === index ? (
                  ...
                  <div 
                    className={`px-6 text-sm text-white/60 overflow-hidden transition-all duration-300 ${openFaq === index ? 'max-h-40 pb-4 opacity-100' : 'max-h-0 opacity-0'}`}
                  >
                    {faq.a}
                  </div>
                </div>
          ...
          <section className="py-20 border-b border-white/10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-3xl mx-auto">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white mb-4">Something not working?</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-white mb-4">Help us build better</h2>
                <p className="text-sm text-white/60 mb-6">
          ...
          <section className="py-20 border-b border-white/10">
            <h2 className="text-2xl font-bold text-white mb-10 text-center">When to reach us</h2>
                ...
                <table className="w-full text-left text-sm text-white/70">
                  ...
                  <tbody className="divide-y divide-white/10">
                    <tr className="hover:bg-white/5 transition-colors">
                      <td className="px-6 py-4 font-semibold text-white">Email</td>
                      <td className="px-6 py-4">24/7</td>
                      <td className="px-6 py-4">2 hours (weekday), 4 hours (weekend)</td>
                    </tr>
                    <tr className="hover:bg-white/5 transition-colors">
                      <td className="px-6 py-4 font-semibold text-white">WhatsApp</td>
                      <td className="px-6 py-4">8am - 9pm</td>
                      <td className="px-6 py-4">15 minutes</td>
                    </tr>
                    <tr className="hover:bg-white/5 transition-colors">
                      <td className="px-6 py-4 font-semibold text-white">In-app chat</td>
                      <td className="px-6 py-4">24/7</td>
