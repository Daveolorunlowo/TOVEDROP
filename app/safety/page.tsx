        ...
        <div className="max-w-4xl mx-auto px-6 sm:px-10 lg:px-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-foreground font-bold mb-1">Real-time tracking</h4>
                    <p className="text-sm text-foreground/60">Your ride is visible to you and our safety team from pickup to dropoff. No blind spots.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <Star className="w-6 h-6 text-purple-brand shrink-0 mt-1" />
                  <div>
                    <h4 className="text-foreground font-bold mb-1">Driver rating system</h4>
                    <p className="text-sm text-foreground/60">After every ride, you rate your driver. Drivers who drop below 4.5★ lose ride access.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <MessageSquare className="w-6 h-6 text-purple-brand shrink-0 mt-1" />
                  <div>
                    <h4 className="text-foreground font-bold mb-1">In-app messaging only</h4>
                    <p className="text-sm text-foreground/60">Chat happens only through TOVEDROP, never on personal numbers. We can see conversations if needed.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <ShieldAlert className="w-6 h-6 text-purple-brand shrink-0 mt-1" />
                  <div>
                    <h4 className="text-foreground font-bold mb-1">Emergency button</h4>
                    <p className="text-sm text-foreground/60">Tap once to alert campus security and a trusted contact. Drivers know about it. It's taken seriously.</p>
                  </div>
                </div>
              </div>
                ...
                <div className="mt-12 w-full space-y-4">
                  <div className="bg-surface-card p-4 rounded-xl border border-white/5 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-foreground text-sm font-bold">Ade Okafor</p>
                        <p className="text-foreground/50 text-xs">Toyota Corolla</p>
                      </div>
                    </div>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white/5 p-6 rounded-xl">
                  ...
                  <ul className="space-y-3 text-sm text-foreground/70">
                    ...
                    <li><strong className="text-foreground">Driver reported reckless student behavior</strong> → Student banned, driver offered psychology support.</li>
                    <li><strong className="text-foreground">Student felt unsafe mid-ride</strong> → Sent backup driver, completed trip free, incident logged.</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <section className="py-20 border-b border-white/10">
            <div className="max-w-2xl mx-auto">
              ...
              <ul className="space-y-4 text-sm text-foreground/70">
                <li><strong className="text-foreground">Rider ratings</strong> — Students are rated too. Drivers can report unsafe behavior.</li>
                <li><strong className="text-foreground">Driver support</strong> — We provide self-defense workshops for drivers (free, optional).</li>
                <li><strong className="text-foreground">Incident support</strong> — If a driver reports a safety concern, we follow up immediately.</li>
                <li><strong className="text-foreground">Legal backing</strong> — We stand behind our drivers. If a false report is made, we support them.</li>
              </ul>
            </div>
          </section>
          ...
          <section className="py-20 text-center">
            <div className="max-w-2xl mx-auto mb-10">
              <h2 className="text-2xl font-bold text-foreground mb-4">We're never done</h2>
