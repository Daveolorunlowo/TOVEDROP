...
export default function AdGenerator() {
 ...
 transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
 className="absolute inset-0 flex flex-col items-center pt-12 bg-primary from-[#111] to-[#000]"
 ...
 className="absolute inset-0 flex flex-col items-center justify-center bg-primary p-8 text-center"
 >
 <motion.div 
 ...
 className="z-10 w-full py-5 bg-primary text-foreground font-black uppercase tracking-wider rounded-xl text-xl shadow-[0_10px_40px_rgba(249,115,22,0.5)] border border-orange-400/50"
 >
 Start Dropping 🚀
 </motion.button>
 </motion.div>
