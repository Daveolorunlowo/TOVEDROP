...
export default function MotionAd() {
 ...
 whileTap={{ scale: 0.95 }}
 onClick={runSequence} 
 className="bg-orange-500 text-white px-10 py-5 rounded-xl font-black text-xl shadow-[0_2px_8px_rgba(0,0,0,0.2)] transition-all"
 >
 INITIALIZE RENDER
 </motion.button>
 </div>
 ...
 className="w-24 h-24 bg-orange-600 rounded-2xl flex items-center justify-center shadow-[0_0_40px_rgba(234,88,12,0.4)] relative z-10"
 >
 ...
 <motion.div initial={{ x: -20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: 0.1, type: "spring" }} className="bg-gray-50 border border-gray-200 p-4 rounded-xl relative transition-colors duration-300">
 ...
 <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.3, type: "spring" }} className="bg-gray-50 border border-gray-200 p-4 rounded-xl relative flex-1 flex flex-col items-center justify-center">
 ...
 <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.4, type: "spring" }} className="bg-gray-50 border border-gray-200 p-4 rounded-xl relative flex-1 flex flex-col items-center justify-center">
 ...
 <motion.div initial={{ y: 50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ type: "spring", delay: 0.5, damping: 15 }} className="w-full bg-gray-50 rounded-2xl p-6 border border-gray-200">
 ...
 <motion.div initial={{ scale: 0, rotateY: 180 }} animate={{ scale: 1, rotateY: 0 }} transition={{ type: "spring", damping: 15 }} className="w-20 h-20 rounded-[24px] bg-primary shadow-[0_0_40px_rgba(249,115,22,0.4),inset_0_2px_4px_rgba(255,255,255,0.3)] z-10 flex items-center justify-center">
 ...
 <motion.div initial={{ scale: 0, filter: "blur(10px)" }} animate={{ scale: 1, filter: "blur(0px)" }} transition={{ delay: 0.4, type: "spring", damping: 12, stiffness: 300 }} className="relative bg-primary text-white px-10 py-4 rounded-full font-sans font-black text-lg z-10 shadow-[0_4px_24px_rgba(217,119,6,0.45),inset_0_1px_0_rgba(255,255,255,0.15)] flex items-center gap-2 cursor-pointer transform hover:scale-105 transition-all">
 Book a Ride
