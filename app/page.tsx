...
function HeroSection() {
 ...
 <button 
 type="submit"
 className="absolute right-3 top-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center rounded-xl text-foreground hover:scale-105 transition-all shadow-lg"
...
function HowItWorksSection() {
 ...
 <div
 className="relative z-10 bg-surface-card border-t-[3px] rounded-xl p-8 w-full lg:w-[420px] shadow-[0_8px_40px_rgba(0,0,0,0.3)] transition-all duration-700"
 style={{
